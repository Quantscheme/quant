...
// Signals 
router.get('/trading-signals', forwardAuthenticated, (req, res) => res.render('signals'));
// Mentorshipd 
router.get('/premium-mentorship', forwardAuthenticated, (req, res) => res.render('mentorship'));
